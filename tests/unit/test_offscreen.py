...
from pyrender import OffscreenRenderer, PerspectiveCamera, DirectionalLight,\
                     SpotLight, PointLight, MetallicRoughnessMaterial, Primitive,\
...
def test_offscreen_renderer(tmpdir):
    ...
    # Fuze trimesh
    fuze_trimesh = trimesh.load('examples/models/fuze.obj', process=False)
    fuze_mesh = Mesh.from_trimesh(fuze_trimesh)

    # Drill trimesh
    drill_trimesh = trimesh.load('examples/models/drill.obj', process=False)
    ...
    # Wood trimesh
    wood_trimesh = trimesh.load('examples/models/wood.obj', process=False)
    wood_mesh = Mesh.from_trimesh(wood_trimesh)

    # Water bottle trimesh
    bottle_gltf = trimesh.load('examples/models/WaterBottle.glb', process=False)
    ...
    #==============================================================================
    # Rendering offscreen from the camera
    #==============================================================================
